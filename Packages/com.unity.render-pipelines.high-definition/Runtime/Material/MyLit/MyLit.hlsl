...
// SurfaceData is defined in MyLit.cs which generates MyLit.cs.hlsl
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/MyLit/MyLit.cs.hlsl"
...
//...MaterialEvaluation is needed earlier in MyLit for occlusion handling (see PreLightData_SetupOcclusion)
...
// NOTE:
//
// This will be available and used in ShaderPassForward.hlsl since in MyLit.shader,
// just before including the core code of the pass (ShaderPassForward.hlsl) we include
// Material.hlsl (or Lighting.hlsl which includes it) which in turn includes us,
// MyLit.shader, via the #if defined(UNITY_MATERIAL_*) glue mechanism.
//
...
// Warning:
//
// Keep MyLitSubShader.cs in synch with what we do here (see AddPixelShaderSlotsForWriteNormalBufferPasses)
...
LightTransportData GetLightTransportData(SurfaceData surfaceData, BuiltinData builtinData, BSDFData bsdfData)
{
    ...
    //
    // In MyLit we also need to deal with vlayering and the tint it might give from the diffuse energy factor,
    ...
    //
    // fraginputs are also ShaderPass/MyLitSharePass.hlsl, we should be able to compute the diffuse energy factor,
                                    ...
                                    PreLightData preLightData, LightData lightData, BSDFData bsdfData, BuiltinData builtinData)
{
    ...
    // TODO This ref doesn't handle the MyLit model
