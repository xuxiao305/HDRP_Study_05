...
{
    class MyLit : RenderPipelineMaterial
    {
        [GenerateHLSL(PackingRules.Exact)]
        public enum MaterialFeatureFlags
        {
            MyLitStandard                = 1 << 0,
            MyLitDualSpecularLobe        = 1 << 1,
            MyLitAnisotropy              = 1 << 2,
            MyLitCoat                    = 1 << 3,
            MyLitIridescence             = 1 << 4,
            MyLitSubsurfaceScattering    = 1 << 5,
            MyLitTransmission            = 1 << 6,
            MyLitCoatNormalMap           = 1 << 7,
            MyLitSpecularColor           = 1 << 8,
            MyLitHazyGloss               = 1 << 9,
        };
        ...
        {
            BaseMetallic = 0,
            SpecularColor = 1, // MaterialFeatureFlags.MyLitSpecularColor
        };
        ...
        {
            Direct = 0,
            HazyGloss = 1, // MaterialFeatureFlags.MyLitHazyGloss
