...
//-----------------------------------------------------------------------------
// SurfaceData is defined in FabricEx.cs which generates FabricEx.cs.hlsl
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/FabricEx/FabricEx.cs.hlsl"
...
// #define FabricEx_DISPLAY_REFERENCE_IBL
...
// Note: This will be available and used in ShaderPassForward.hlsl since in FabricEx.shader,
// just before including the core code of the pass (ShaderPassForward.hlsl) we include
// Material.hlsl (or Lighting.hlsl which includes it) which in turn includes us,
// FabricEx.shader, via the #if defined(UNITY_MATERIAL_*) glue mechanism.
...
BSDFData ConvertSurfaceDataToBSDFData(uint2 positionSS, SurfaceData surfaceData)
{
    ...
    if (HasFlag(surfaceData.materialFeatures, MATERIALFEATUREFLAGS_FABRIC_EX_SUBSURFACE_SCATTERING))
    {
...
void ModifyBakedDiffuseLighting(float3 V, PositionInputs posInput, SurfaceData surfaceData, inout BuiltinData builtinData)
{
    ...
    if (HasFlag(bsdfData.materialFeatures, MATERIALFEATUREFLAGS_FABRIC_EX_TRANSMISSION))
    {
        builtinData.bakeDiffuseLighting += builtinData.backBakeDiffuseLighting * bsdfData.transmittance;
    }

    // For SSS we need to take into account the state of diffuseColor 
    if (HasFlag(bsdfData.materialFeatures, MATERIALFEATUREFLAGS_FABRIC_EX_SUBSURFACE_SCATTERING))
    {
...
// For FabricEx we have two type of BRDF
// Non-Metal: Cotton, deim, flax and common FabricExs
...
#include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/FabricEx/FabricExReference.hlsl"
//-----------------------------------------------------------------------------
