...
{
    class FabricExSettingsView : MasterNodeSettingsView
    {
        FabricExMasterNode m_Node;
        ...
        public FabricExSettingsView(FabricExMasterNode node) : base(node)
        {
            m_Node = node;
            PropertySheet ps = new PropertySheet();

            int indentLevel = 0;
            ps.Add(new PropertyRow(CreateLabel("Surface Type Ex", indentLevel)), (row) =>
            {
            ...
            if (m_Node.surfaceType == SurfaceType.Transparent)
            {
                ...
                ps.Add(new PropertyRow(CreateLabel("Depth Write EX", indentLevel)), (row) =>
                {
                    row.Add(new Toggle(), (toggle) =>
                    {
                ...
                {
                    ps.Add(new PropertyRow(CreateLabel("Cull Mode EX", indentLevel)), (row) =>
                    {
            ...
            ps.Add(new PropertyRow(CreateLabel("Alpha Clipping Ex", indentLevel)), (row) =>
            {
                row.Add(new Toggle(), (toggle) =>
                {
            ...
            {
                row.Add(new EnumField(FabricExMasterNode.MaterialType.CottonWool), (field) =>
                {
        ...
        void ChangeMaterialType(ChangeEvent<Enum> evt)
        {
            ...
            m_Node.materialType = (FabricExMasterNode.MaterialType)evt.newValue;
        }
        ...
        void ChangeBlendMode(ChangeEvent<Enum> evt)
        {
            ...
            AlphaMode alphaMode = GetAlphaMode((FabricExMasterNode.AlphaModeFabricEx)evt.newValue);
        ...
        public AlphaMode GetAlphaMode(FabricExMasterNode.AlphaModeFabricEx alphaModeLit)
        {
            switch (alphaModeLit)
            {
                case FabricExMasterNode.AlphaModeFabricEx.Alpha:
                    return AlphaMode.Alpha;
                case FabricExMasterNode.AlphaModeFabricEx.Premultiply:
                    return AlphaMode.Premultiply;
                case FabricExMasterNode.AlphaModeFabricEx.Additive:
        ...
        public FabricExMasterNode.AlphaModeFabricEx GetAlphaModeLit(AlphaMode alphaMode)
        {
            switch (alphaMode)
            {
                case AlphaMode.Alpha:
                    return FabricExMasterNode.AlphaModeFabricEx.Alpha;
                case AlphaMode.Premultiply:
                    return FabricExMasterNode.AlphaModeFabricEx.Premultiply;
                case AlphaMode.Additive:
                    return FabricExMasterNode.AlphaModeFabricEx.Additive;
                default:
                    {
