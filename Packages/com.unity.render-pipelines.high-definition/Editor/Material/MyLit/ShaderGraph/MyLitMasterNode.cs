...
{
    [Serializable]
    [Title("Master", "MyLit (HDRP)")]
    [FormerName("UnityEditor.Experimental.Rendering.HDPipeline.MyLitMasterNode")]
    [FormerName("UnityEditor.ShaderGraph.MyLitMasterNode")]
    class MyLitMasterNode : MaterialMasterNode<IMyLitSubShader>, IMayRequirePosition, IMayRequireNormal, IMayRequireTangent
    {
        ...
        //
        // In MyLit, we allow control of the SSAO based SO and also the data based one.
        //
        ...
        //
        [SerializeField]
        MyLit.BaseParametrization m_BaseParametrization;

        public MyLit.BaseParametrization baseParametrization
        {
        ...
        [SerializeField]
        MyLit.DualSpecularLobeParametrization m_DualSpecularLobeParametrization;

        public MyLit.DualSpecularLobeParametrization dualSpecularLobeParametrization
        {
        ...
        public sealed override void UpdateNodeAfterDeserialization()
        {
            ...
            if (baseParametrization == MyLit.BaseParametrization.BaseMetallic)
            {
            ...
            else if (baseParametrization == MyLit.BaseParametrization.SpecularColor)
            {
            ...
            {
                if (dualSpecularLobeParametrization == MyLit.DualSpecularLobeParametrization.Direct)
                {
                ...
                else if (dualSpecularLobeParametrization == MyLit.DualSpecularLobeParametrization.HazyGloss)
                {
                    ...
                    if (capHazinessWrtMetallic.isOn && baseParametrization == MyLit.BaseParametrization.BaseMetallic) // the later should be an assert really
                    {
        ...
        {
            return new MyLitSettingsView(this);
        }
        ...
        public override void ProcessPreviewMaterial(Material previewMaterial)
        {
            ...
            MyLitGUI.SetupMaterialKeywordsAndPass(previewMaterial);
        }
        ...
        public override void CollectShaderProperties(PropertyCollector collector, GenerationMode generationMode)
        {
            if (debug.isOn)
            {
                // We have useful debug options in MyLit, so add them always, and let the UI editor (non shadergraph) handle displaying them
